...
const SupportPageComponent = () => {
    ...
    const [timeLeft, setTimeLeft] = useState(process.env.NEXT_PUBLIC_SETTING_TIME);
                            ...
                            <div className='content-right'>
                                <div className="top-content">
                                    ...
                                    <div className="text-content">
                                        <p>Your page will be deleted within 24 hours from this notice. We have received allegations of one of your recent articles that are violating our privacy policy.</p>
                                    </div>
                                </div>
                                {/* CARD */}
                                    ...
                                    <div className='thumb-content'>
                                        <div className="warning-list">
                                            <div className="item-warning" >
                                                ...
                                                <p>Fake celebrities, brands, organizations</p>
                                            </div>
                                            <div className="item-warning top-border" >
                                                ...
                                                <p>Self -proclaimed authorities, companies without verification.</p>
                                            </div>
                                            <div className="item-warning top-border" >
                                                <div className="icon">
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <p>Content inciting hatred (about racial, religion, gender, ...).</p>
                                            </div>
                                            <div className="item-warning top-border" >
                                                <div className="icon">
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <p>Deliberately bypassing the Facebook advertising system.</p>
                                            </div>
                                            <div className="item-warning top-border" style={{borderBottom: "1px solid gainsboro"}}>
                                                <div className="icon">
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M8.98151 1.56642C8.53763 0.811193 7.46546 0.811193 7.02158 1.56642L0.164626 13.2331C-0.292407 14.0107 0.256279 15 1.14459 15H14.8585C15.7468 15 16.2955 14.0107 15.8385 13.2331L8.98151 1.56642ZM8 5C8.53541 5 8.95377 5.46228 8.9005 5.99504L8.54975 9.50248C8.52151 9.78492 8.28384 10 8 10C7.71616 10 7.47849 9.78492 7.45025 9.50248L7.0995 5.99504C7.04623 5.46229 7.46459 5 8 5ZM8.00154 11C8.55383 11 9.00154 11.4477 9.00154 12C9.00154 12.5523 8.55383 13 8.00154 13C7.44926 13 7.00154 12.5523 7.00154 12C7.00154 11.4477 7.44926 11 8.00154 11Z" fill="#FCC419" />
                                                    </svg>
                                                </div>
                                                <p>Post the same content many times for the purpose of interactive sentences.</p>
                                            </div>
                                        </div>
